...
QT_MOC_LITERAL(24, 0), // ""
QT_MOC_LITERAL(25, 8), // "loadFile"
QT_MOC_LITERAL(34, 8) // "saveFile"

    },
    "ChessView\0doubleClicked\0\0loadFile\0"
    "saveFile"
};
...
void ChessView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->saveFile((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ChessView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChessView::doubleClicked)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<ChessView, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
